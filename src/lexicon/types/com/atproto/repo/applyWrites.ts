...
export function isCreateResult(v: unknown): v is CreateResult {
    return (
        isObj(v) && hasProp(v, "$type") && v.$type === "com.atproto.repo.applyWrites#createResult"
    );
}
...
export function isUpdateResult(v: unknown): v is UpdateResult {
    return (
        isObj(v) && hasProp(v, "$type") && v.$type === "com.atproto.repo.applyWrites#updateResult"
    );
}
...
export function isDeleteResult(v: unknown): v is DeleteResult {
    return (
        isObj(v) && hasProp(v, "$type") && v.$type === "com.atproto.repo.applyWrites#deleteResult"
    );
}
