...
export function isMessageRef(v: unknown): v is MessageRef {
    return isObj(v) && hasProp(v, "$type") && v.$type === "chat.bsky.convo.defs#messageRef";
}
...
export function isMessageInput(v: unknown): v is MessageInput {
    return isObj(v) && hasProp(v, "$type") && v.$type === "chat.bsky.convo.defs#messageInput";
}
...
export function isMessageView(v: unknown): v is MessageView {
    return isObj(v) && hasProp(v, "$type") && v.$type === "chat.bsky.convo.defs#messageView";
}
...
export function isDeletedMessageView(v: unknown): v is DeletedMessageView {
    return isObj(v) && hasProp(v, "$type") && v.$type === "chat.bsky.convo.defs#deletedMessageView";
}
...
export function isMessageViewSender(v: unknown): v is MessageViewSender {
    return isObj(v) && hasProp(v, "$type") && v.$type === "chat.bsky.convo.defs#messageViewSender";
}
...
export interface ConvoView {
    ...
    lastMessage?: MessageView | DeletedMessageView | { $type: string; [k: string]: unknown };
    muted: boolean;
    opened?: boolean;
    unreadCount: number;
    [k: string]: unknown;
...
export function isConvoView(v: unknown): v is ConvoView {
    return isObj(v) && hasProp(v, "$type") && v.$type === "chat.bsky.convo.defs#convoView";
}
...
export function isLogBeginConvo(v: unknown): v is LogBeginConvo {
    return isObj(v) && hasProp(v, "$type") && v.$type === "chat.bsky.convo.defs#logBeginConvo";
}
...
export function isLogLeaveConvo(v: unknown): v is LogLeaveConvo {
    return isObj(v) && hasProp(v, "$type") && v.$type === "chat.bsky.convo.defs#logLeaveConvo";
}
...
export interface LogCreateMessage {
    rev: string;
    convoId: string;
    message: MessageView | DeletedMessageView | { $type: string; [k: string]: unknown };
    [k: string]: unknown;
}

export function isLogCreateMessage(v: unknown): v is LogCreateMessage {
    return isObj(v) && hasProp(v, "$type") && v.$type === "chat.bsky.convo.defs#logCreateMessage";
}
...
export function isLogDeleteMessage(v: unknown): v is LogDeleteMessage {
    return isObj(v) && hasProp(v, "$type") && v.$type === "chat.bsky.convo.defs#logDeleteMessage";
}
