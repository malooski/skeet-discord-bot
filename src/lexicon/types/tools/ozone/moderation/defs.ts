...
export function isModEventView(v: unknown): v is ModEventView {
    return (
        isObj(v) && hasProp(v, "$type") && v.$type === "tools.ozone.moderation.defs#modEventView"
    );
}
...
export interface SubjectStatusView {
    ...
    subject:
        ...
        | ComAtprotoRepoStrongRef.Main
        | { $type: string; [k: string]: unknown };
    hosting?: AccountHosting | RecordHosting | { $type: string; [k: string]: unknown };
    subjectBlobCids?: string[];
...
export function isModEventReverseTakedown(v: unknown): v is ModEventReverseTakedown {
    return (
        isObj(v) &&
        hasProp(v, "$type") &&
...
export function isModEventResolveAppeal(v: unknown): v is ModEventResolveAppeal {
    return (
        isObj(v) &&
        hasProp(v, "$type") &&
...
export function isModEventComment(v: unknown): v is ModEventComment {
    return (
        isObj(v) && hasProp(v, "$type") && v.$type === "tools.ozone.moderation.defs#modEventComment"
    );
}
...
export function isModEventReport(v: unknown): v is ModEventReport {
    return (
        isObj(v) && hasProp(v, "$type") && v.$type === "tools.ozone.moderation.defs#modEventReport"
    );
}
...
export function isModEventLabel(v: unknown): v is ModEventLabel {
    return (
        isObj(v) && hasProp(v, "$type") && v.$type === "tools.ozone.moderation.defs#modEventLabel"
    );
}
...
export function isModEventMute(v: unknown): v is ModEventMute {
    return (
        isObj(v) && hasProp(v, "$type") && v.$type === "tools.ozone.moderation.defs#modEventMute"
    );
}
...
export function isModEventUnmute(v: unknown): v is ModEventUnmute {
    return (
        isObj(v) && hasProp(v, "$type") && v.$type === "tools.ozone.moderation.defs#modEventUnmute"
    );
}
...
export function validateModEventMuteReporter(v: unknown): ValidationResult {
    return lexicons.validate("tools.ozone.moderation.defs#modEventMuteReporter", v);
}
...
export function isModEventUnmuteReporter(v: unknown): v is ModEventUnmuteReporter {
    return (
        isObj(v) &&
        hasProp(v, "$type") &&
...
export function validateModEventUnmuteReporter(v: unknown): ValidationResult {
    return lexicons.validate("tools.ozone.moderation.defs#modEventUnmuteReporter", v);
}
...
export function isModEventEmail(v: unknown): v is ModEventEmail {
    return (
        isObj(v) && hasProp(v, "$type") && v.$type === "tools.ozone.moderation.defs#modEventEmail"
    );
}
...
export function isModEventDivert(v: unknown): v is ModEventDivert {
    return (
        isObj(v) && hasProp(v, "$type") && v.$type === "tools.ozone.moderation.defs#modEventDivert"
    );
}
...
export function isModEventTag(v: unknown): v is ModEventTag {
    return isObj(v) && hasProp(v, "$type") && v.$type === "tools.ozone.moderation.defs#modEventTag";
}
...
export function isAccountEvent(v: unknown): v is AccountEvent {
    return (
        isObj(v) && hasProp(v, "$type") && v.$type === "tools.ozone.moderation.defs#accountEvent"
    );
}
...
export function isIdentityEvent(v: unknown): v is IdentityEvent {
    return (
        isObj(v) && hasProp(v, "$type") && v.$type === "tools.ozone.moderation.defs#identityEvent"
    );
}
...
export function isRecordEvent(v: unknown): v is RecordEvent {
    return isObj(v) && hasProp(v, "$type") && v.$type === "tools.ozone.moderation.defs#recordEvent";
}
...
export function isRepoView(v: unknown): v is RepoView {
    return isObj(v) && hasProp(v, "$type") && v.$type === "tools.ozone.moderation.defs#repoView";
}
...
export function isRepoViewDetail(v: unknown): v is RepoViewDetail {
    return (
        isObj(v) && hasProp(v, "$type") && v.$type === "tools.ozone.moderation.defs#repoViewDetail"
    );
}
...
export function isRecordView(v: unknown): v is RecordView {
    return isObj(v) && hasProp(v, "$type") && v.$type === "tools.ozone.moderation.defs#recordView";
}
...
export function isModeration(v: unknown): v is Moderation {
    return isObj(v) && hasProp(v, "$type") && v.$type === "tools.ozone.moderation.defs#moderation";
}
...
export interface BlobView {
    ...
    size: number;
    createdAt: string;
    details?: ImageDetails | VideoDetails | { $type: string; [k: string]: unknown };
    moderation?: Moderation;
    [k: string]: unknown;
}

export function isBlobView(v: unknown): v is BlobView {
    return isObj(v) && hasProp(v, "$type") && v.$type === "tools.ozone.moderation.defs#blobView";
}
...
export function isImageDetails(v: unknown): v is ImageDetails {
    return (
        isObj(v) && hasProp(v, "$type") && v.$type === "tools.ozone.moderation.defs#imageDetails"
    );
}
...
export function isVideoDetails(v: unknown): v is VideoDetails {
    return (
        isObj(v) && hasProp(v, "$type") && v.$type === "tools.ozone.moderation.defs#videoDetails"
    );
}
...
export function isAccountHosting(v: unknown): v is AccountHosting {
    return (
        isObj(v) && hasProp(v, "$type") && v.$type === "tools.ozone.moderation.defs#accountHosting"
    );
}
...
export function isRecordHosting(v: unknown): v is RecordHosting {
    return (
        isObj(v) && hasProp(v, "$type") && v.$type === "tools.ozone.moderation.defs#recordHosting"
    );
}
